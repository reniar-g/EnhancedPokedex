...
public class EnhancedPokedexMVC {
    ...
    private static void runPokedex() {
        ...
        while (running) {
            ...
            switch (choice) {
                case 1 ->
                    pokemonController.pokemonManagement();
                case 2 ->
                    moveController.moveManagement(); // Remove duplicate
                case 3 ->
                    itemController.itemManagement();
                case 4 ->
                    trainerController.trainerManagement(); // Uncomment when ready
                case 0 ->
                    running = false;
                default ->
	...
	private static void loadDefaultData() {
		...
		// Load default items into the item controller
		itemController.loadDefaultItems();
	}
